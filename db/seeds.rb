...
pets = [
    {name: "Bear", color: "Red", breed: "Chow Chow", dob: "2014-04-15", gender: 0, species: 0, owner_id: 2},
    {name: "Meatball", color: "Tan", breed: "French Bulldog", dob: "2013-07-05", gender: 0, species: 0, owner_id: 11},
    {name: "Oreo", color: "Black & White", breed: "Dalmatian", dob: "2016-03-12", gender: 0, species: 0, owner_id: 5},
    {name: "Lucky", color: "White & Tan", breed: "Jack Russell Terrier", dob: "2015-09-20", gender: 0, species: 0, owner_id: 6},
    {name: "Bubba", color: "Tri Color", breed: "Bernedoodle", dob: "2017-06-17", gender: 0, species: 0, owner_id: 9},
    {name: "Toby", color: "White", breed: "Bull Terrier", dob: "2018-08-18", gender: 0, species: 0, owner_id: 1},
    {name: "Tiger", color: "Brown Mackerel", breed: "Toyger", dob: "2015-06-20", gender: 0, species: 1, owner_id: 1},
    {name: "Pearl", color: "White", breed: "Exotic Shorthair", dob: "2013-10-02", gender: 1, species: 1, owner_id: 7},
    {name: "Shadow", color: "Black", breed: "Bombay", dob: "2014-03-15", gender: 1, species: 1, owner_id: 5},
    {name: "Garfield", color: "Tabby", breed: "Exotic Shorthair", dob: "2012-11-03", gender: 0, species: 1, owner_id: 8},
    {name: "Smoky", color: "Gray", breed: "Scottish Fold", dob: "2019-01-01", gender: 0, species: 1, owner_id: 5},
    {name: "Lady", color: "Orange", breed: "Pomeranian", dob: "2013-05-11", gender: 1, species: 0, owner_id: 4},
    {name: "Wiley", color: "Black & White", breed: "Border Collie", dob: "2017-08-12", gender: 0, species: 0, owner_id: 9},
    {name: "Chester", color: "Tan", breed: "Coonhound", dob: "2016-02-10", gender: 0, species: 0, owner_id: 6},
    {name: "Odie", color: "Tri Color", breed: "Beagle", dob: "2016-02-07", gender: 0, species: 0, owner_id: 5},
    {name: "Olive", color: "Black", breed: "Chihuahua", dob: "2014-09-03", gender: 1, species: 0, owner_id: 7},
    {name: "Onyx", color: "Black", breed: "Cocker Spaniel", dob: "2017-08-01", gender: 1, species: 0, owner_id: 6},
    {name: "Bozo", color: "White", breed: "American Curl", dob: "2018-06-24", gender: 0, species: 1, owner_id: 9},
    {name: "Bugsy", color: "Tan", breed: "Pug", dob: "2015-04-14", gender: 0, species: 0, owner_id: 10},
    {name: "Dash", color: "Fawn", breed: "Greyhound", dob: "2018-05-18", gender: 0, species: 0, owner_id: 10},
    {name: "Bean", color: "Red", breed: "Bloodhound", dob: "2017-07-19", gender: 0, species: 0, owner_id: 2},
    {name: "Hunter", color: "Sable & White", breed: "Alaskan Malamute", dob: "2018-03-18", gender: 0, species: 0, owner_id: 7},
    {name: "Coco", color: "Light Brown", breed: "Shih Tzu", dob: "2016-04-21", gender: 1, species: 0, owner_id: 2},
    {name: "Charlie", color: "Chocolate", breed: "American Water Spaniel", dob: "2013-05-12", gender: 0, species: 0, owner_id: 5},
    {name: "Odin", color: "Apricot", breed: "Poodle", dob: "2014-06-15", gender: 0, species: 0, owner_id: 8},
    {name: "Cinnamon", color: "Chocolate & Tan", breed: "Dachshund", dob: "2016-02-08", gender: 1, species: 0, owner_id: 6},
    {name: "Dex", color: "Cream", breed: "Cymric", dob: "2017-07-04", gender: 0, species: 1, owner_id: 8},
    {name: "Joy", color: "Spotted Golden", breed: "Savannah", dob: "2017-09-01", gender: 1, species: 1, owner_id: 7},
    {name: "Junebug", color: "Brown", breed: "Chesapeake Bay Retriever", dob: "2018-06-17", gender: 1, species: 0, owner_id: 11},
    {name: "Fluffy", color: "White", breed: "Samoyed", dob: "2016-08-16", gender: 1, species: 0, owner_id: 3},
    {name: "Hamlet", color: "Tan", breed: "Sphynx", dob: "2019-02-20", gender: 0, species: 1, owner_id: 3},
    {name: "Snowy", color: "White", breed: "Turkish Angora", dob: "2017-01-12", gender: 1, species: 1, owner_id: 3},
    {name: "Remy", color: "Cream", breed: "Borzoi", dob: "2018-03-07", gender: 0, species: 0, owner_id: 8},
    {name: "Cooper", color: "Black", breed: "Newfoundland", dob: "2016-05-12", gender: 0, species: 0, owner_id: 11},
    {name: "Nugget", color: "Golden", breed: "Golden Retriever", dob: "2014-12-08", gender: 0, species: 0, owner_id: 3}
]
