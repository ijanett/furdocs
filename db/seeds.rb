...
clinics = [
    ...
    {name: "Dales City Clinic", location: "Dales City, Virginia", description: "We care for you and your companion and will work with you to help you understand your pet's health needs."},
    ...
    {name: "Paradise Animal Clinic", location: "Gardenstowne, Virginia", description: "A warm and inviting atmosphere combined with the latest in veterinary medicine and surgery, Petfield Clinic offers an exceptional concept in animal care."},
